...
class TestCorrelatedData:
    ...
    def test_icd10_code_with_disease(self, faker):
    ...
    def test_symptom_with_disease(self, faker):
    ...
    def test_disease_symptoms(self, faker):
    ...
    def test_medication_with_disease(self, faker):
    ...
    def test_medications(self, faker):
    ...
    def test_diseases_by_symptom(self, faker):
    ...
    def test_patient_scenario_random(self, faker):
    ...
    def test_patient_scenario_specific_disease(self, faker):
    ...
    def test_diagnosis_correlated(self, faker):
